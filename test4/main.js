...
function init() {
  ...
  const planeGeometory = new THREE.PlaneGeometry(1,1);
  const octahedronGeometory = new THREE.OctahedronGeometry(0.5);
  ...
  plane = new THREE.Mesh(planeGeometory, material);
  octahedron = new THREE.Mesh(octahedronGeometory, material);
